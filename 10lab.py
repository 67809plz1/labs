def p1():
    import json
    with open('файлы/файл.json', encoding='utf-8') as f:
        file = json.load(f)
...
def p2():
    ...
    with open('файлы/файл.json', 'w', encoding='utf-8') as f:
...
def p3():
    file = {}
    with open('файлы/en-ru.txt', 'r', encoding = 'utf-8') as f:
        for line in f:
    ...
    with open('файлы/ru-en.txt', 'w', encoding='utf-8') as f:
